...
var Rational = /** @class */ (function () {
    function Rational(numerador, denominador) {
        this.numerador = numerador;
        this.denominador = denominador;
    }
    Rational.prototype.getNumerador = function () {
        return this.numerador;
    };
    Rational.prototype.getDenominador = function () {
    ...
    Rational.prototype.setNumerador = function (numerador) {
        this.numerador = numerador;
    };
    Rational.prototype.setDenominador = function (denominador) {
        if (denominador != 0) {
            this.denominador = denominador;
        }
        else {
    ...
    Rational.prototype.inverso = function () {
    ...
    Rational.prototype.resta = function (num1, den1, num2, den2) {
        var newDenominador;
        var newNumerador;
        if (den1 == den2) {
            newDenominador = den1 = den2;
    ...
    Rational.prototype.multiplicacion = function (num1, den1, num2, den2) {
        var newDenominador;
        var newNumerador;
        if (den1 == den2) {
            newDenominador = den1 = den2;
